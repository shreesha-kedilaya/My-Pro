...
//func hasTwoPairs(_ array: [Float], sum: Float) -> Bool {
...
func findMajorityElement(_ array: [Float]) -> Float {
    var count = 1
    var majIndex = 0
...
func findPivot(_ array: [Int], high: Int, low: Int) -> Int{
...
func binarySearch(_ array: [Int], low: Int, high: Int, element: Int) -> Int {
    if high < low {
        return -1
    }
...
func pivotedBinarySearch(_ array: [Int], element: Int) -> Int {
...
func findArrayRotatedBetter(_ array: [Int],low: Int, high: Int, key: Int) -> Int {
    if high < low {
        return -1
    }
